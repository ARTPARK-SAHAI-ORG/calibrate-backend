...
| Variable                            | Meaning                                                                                                                                                                                                                                                                                |
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`MAX_CONCURRENT_JOBS`**           | Global cap on concurrent background jobs across queues. Defaults to **`1`** when unset ([`src/utils.py`](src/utils.py)), matching Compose and the tests.                                  |
