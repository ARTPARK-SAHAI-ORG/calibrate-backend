...
async def update_stt_visibility(
    ...
    # Type-check: this endpoint shares STT eval jobs only. Without the
    # check, an owner could pass an annotation-eval / tts-eval UUID and
    # bypass that route's own gating (e.g. the completed-only requirement
    # on annotation-eval shares).
